...
impl IntcodeComp {
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![1101,2,3,0,1102,2,3,4,99];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    ...
    /// let tape: Vec<i32> = vec![3,5,3,6,1101,0,0,9,99,0];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// 
    ...
    /// // product.
    /// let tape: Vec<i32> = vec![3,5,3,6,1101,0,0,13,2,5,6,14,99,0,0];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// 
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![1,5,6,4,0,49,50];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![2,5,6,4,0,3,33];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    /// assert_eq!(comp.get(4), 99);
    ...
    fn input(&mut self) {
        ...
        match maybe_input {
            Some(input) => {
                let pos: usize = self.tape[self.head] as usize;
                self.head += 1;
                self.tape[pos] = input;
            },
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![4,3,99,50];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![5,1,8,99,5,9,9,99,4,0];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    /// ```
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![6,5,8,99,6,0,9,99,4,0];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    /// ```
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![7,1,2,0,7,2,1,4,99];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
    ...
    /// 
    /// ```
    /// let tape: Vec<i32> = vec![8,9,10,0,8,10,11,4,99,1,2,2];
    /// let mut comp = intcode::IntcodeComp::new(tape);
    /// comp.start();
    /// assert_eq!(*comp.state(), intcode::IntcodeState::Finished);
...
/// ```
pub fn to_tape(line: &str) -> Vec<i32> {
